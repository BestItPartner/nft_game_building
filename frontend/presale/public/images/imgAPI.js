const imgAPI = {
  ...
  crypto: [
    ...
    '/images/crypto/hexa-orange.png',
    '/images/crypto/hexa-green.png',
    '/images/crypto/video_cover.jpg',
    '/images/crypto/background.jpg',
    '/images/crypto/crypto_laptop.png'
  ],
  wallet: [
    '/images/crypto/wallet_metamask.png',
    '/images/crypto/wallet_coinbase.png',
    '/images/crypto/wallet_walletconnect.png'
  ],
};
