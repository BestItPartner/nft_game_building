...
import {Container, Grid, Paper, Typography, Dialog, DialogContent, DialogTitle, IconButton, Zoom, TextField} from '@material-ui/core';
            ...
            <div className={classes.counter}>
              <div className={classes.higher}>
                ...
                <Paper className={classes.paper}>
                  ...
                  <Typography display="block">
                    Drills, Hammers, Wrenches, Saws, Torches
                  </Typography>
                </Paper>                
              </div>      
              <div className={classes.higher}>
